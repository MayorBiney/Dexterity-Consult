/*
Template: Dexterity Consult Limited
Author: MayorDesigns
*/
...
(function ($) {
	...
	$(document).ready(function () {
		...
		$(".dexterity-mobile-nav ul li ul").addClass("dropdown-menu");
		$(".dexterity-mobile-nav ul li ul").parent().addClass("dropdown");

		$(".main-menu ul li ul").parent().addClass("dropdown");
		$('.main-menu li.dropdown > a').append("<i class='fas fa-caret-down'></i>");

		/** Sidr submenu */
		function dexterityMobileMenu() {
			$('.dexterity-mobile-nav ul')[0].classList.add("dexterity-navbar-mobile");

			var $nav = $(".dexterity-navbar-mobile"),
			...
			// For Title
			$('.dexterity-navbar-mobile li.dropdown > a').each(function () {
				$(this).siblings("ul").find("li.dropdown-back").prepend("<div class='title'><a style='color: #000'>" + $(this).text() + "</a></div>");
			});

			// open sub-level
			$('.dexterity-navbar-mobile li.dropdown > a').append("<span class='dropdown-toggle' data-toggle='dropdown'></span>");
			$('.dexterity-navbar-mobile li.dropdown > a .dropdown-toggle').on("click", function (e) {
				e.preventDefault();
				e.stopPropagation();

				$(this).parent().parent().addClass("is-open");
				$(this).parents().find('.dexterity-navbar-mobile').addClass("is-parent");


				var header = $(this).parent().parent().find('ul.dropdown-menu').height(),
					gutter = $('.dexterity-mobile-nav');
			...
			$back_btn.on("click", ".dropdown-back", function (e) {
				...
				var gutter = $('.dexterity-mobile-nav');
...
if (mapId || contactMapId || servicesMapId) {
	...
	function initMap() {
		var footerLocation = [
			['Dexterity Consult', 5.6004900322892155, -0.17747778370280748],
			['Dexterity Consult', 5.6004900322892155, -0.17747778370280748]
		];
		...
		// Services Map
		var servicesLocation = { lat: 5.600496038453617, lng: -0.17748180701564314 };
		...
		// Contact MapId
		var contactLocation = { lat: 5.600496038453617, lng: -0.17748180701564314 };
